...
func newFixtures() (*tracetest.SpanRecorder, []Option) {
...
func newProducer(t *testing.T, opts ...Option) *Producer {
...
func consumeMessage(t *testing.T, tp kafka.TopicPartition, opts ...Option) *kafka.Message {
